...
exchange1 = Exchange('e68faee7-753e-49a6-a372-dc1cdc0dae03', 'email@none',
                     '-j1WjK_KnE8cQOVCYOb9WTM-qKLhyfp-DdVXSAjJthE', 'ccgxa2udCPYcw9T1mKAXud2hHgOX_14q__KVK7p910E')
exchange2 = Exchange('224c74ed-eeac-47d2-b8fe-165a0e30815f', 'email@none',
                     '9WsE02XcMAekmjKHoj9Zq7_uVqc8dVz1Fq8czbZOq_Y', '2yOdhL1NM5lyX7Mt8pHVYfkE51UkoSuGUrv6z4OT-c4')
exchange3 = Exchange('97de5cec-33e6-49ae-8ee8-8865ce357625', 'differentemail@notsonone',
...
@pytest.fixture
def an_exchange_with_different_email() -> Exchange:
    return exchange3


@pytest.fixture
def two_exchanges_with_same_email() -> List[Exchange]:
