...
class TestToken:
    ...
    def test_handle_should_return_exchanges_given_by_repository(self, mock_exchange_repo, generic_event,
        ...
        # Given
        mock_exchange_repo.get_account_exchanges.return_value = two_exchanges_with_same_email
        ...
        assert response['body'] == json.dumps(
            [two_exchanges_with_same_email[0].__dict__, two_exchanges_with_same_email[1].__dict__])

    @patch('hallebarde.get_account_exchanges.exchange_repository')
    def test_handle_should_extract_email_from_headers(self, mock_exchange_repo, generic_event):
        # Given
        ...
        # Then
        mock_exchange_repo.get_account_exchanges.assert_called_once_with(generic_event['headers']['email'])
